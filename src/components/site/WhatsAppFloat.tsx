...
const WhatsAppFloat = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-[#25D366] text-white pl-2 pr-4 py-2 shadow-[0_10px_30px_-10px_rgba(37,211,102,0.7)] hover:shadow-[0_14px_40px_-10px_rgba(37,211,102,0.9)] transition-all hover:-translate-y-0.5">
        ...
        <span className="hidden sm:inline font-mono-ed text-[11px] uppercase tracking-[0.22em] font-semibold">
          WhatsApp
        </span>
      </div>
    </a>
